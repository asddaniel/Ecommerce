...
export default function Testimony() {
    return (<div>
            <section className="relative flex px-0 fixed top-13">


                    <div className="flex flex-col justify-center  w-full min-h-screen pb-10 px-3  bg-white   overflow-y-scroll">
                        <h1 className="text-2xl font-semibold text-gray-800 capitalize lg:text-3xl dark:text-white ">
                             <span className="text-black">commentaires</span>
                        </h1>

                        <div className="grid w-full grid-cols-1 gap-8 mt-8 2xl:grid-cols-4 lg:mt-16 md:grid-cols-2 lg:grid-cols-1">
