    ...
    return (
        <>
			...
			<div className="flex w-full space-x-2 sm:space-x-4">
				<img className="flex-shrink-0 object-cover w-20 h-20 dark:border-transparent rounded outline-none sm:w-32 sm:h-32 dark:bg-gray-500" src={props.link_image} alt="Polaroid camera" />
				<div className="flex flex-col justify-between w-full pb-4">
					...
					<div className="flex text-sm divide-x">
						<button onClick={() => { props.onDelete(props.id)}} type="button" className="flex items-center px-2 py-1 pl-0 space-x-1">
